...
tf.flags.DEFINE_string("filter_sizes", "2,3,3,3,3,3,4", "Comma-separated filter sizes (default: '1,2,3,4,5,6,8')")
...
#tf.flags.DEFINE_string("filter_sizes", "3", "Comma-separated filter sizes (default: '1,2,3,4,5,6,8')")
#tf.flags.DEFINE_string("num_filters", "300", "Number of filters per filter size (default: 50,100,150,150,200,200,200)")
